namespace Vidly.Migrations
{
    ...
    public partial class SetMovieClassToDateTime2 : DbMigration
    {
        public override void Up()
        {
            AlterColumn("dbo.Movies", "RealeseDate", c => c.DateTime(nullable: false, precision: 7, storeType: "datetime2"));
